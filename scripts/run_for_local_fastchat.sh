...
# rm -rf ~/.cache/pip && cd ~/.cache/ && cp /workspace/qanything_local/pip_deps.zip .  && unzip /workspace/qanything_local/pip_deps.zip  && mv root/.cache/pip . && rm -rf root
# rm -rf ~/.cache/pip && cd ~/.cache/ && tar -xvf /workspace/qanything_local/pip_deps.tar
