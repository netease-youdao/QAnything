...
**一句话总结：python版本适合快速体验新功能，docker版本适合二次开发并用于实际生产环境，新功能暂缓支持，有定制商业化需求可以联系：xxx**
...
| 支持多卡推理                            | ❌                             | ✅  [详情](#多卡推理) |                                                                   |
| 支持Mac（M系列芯片）                      | ✅                             | ❌          | 目前在mac下运行本地LLM依赖llamacpp，速度较慢，问答一次时间最长可能需要数分钟，建议使用OpenaAI-API的方式调用模型服务                     |
